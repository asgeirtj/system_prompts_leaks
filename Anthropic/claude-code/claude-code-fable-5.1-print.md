...
prompt as assembled at runtime. Reproduce with `node capture/capture.mjs claude --print --model claude-fable-5-1`. Claude Code v2.1.258.18d in `-p` (print) mode, model `claude-fable-5-1`, 20,938 characters and 29 tools as sent. Home directory, username, git identity, gateway host, OS build,
...
[prompt/CLAUDECODE/claude-fable-5-1-print-system-prompt.md](https://github.com/Continuum-AI-Corp/OrcaReplay/blob/main/prompt/CLAUDECODE/claude-fable-5-1-print-system-prompt.md).</sub>
