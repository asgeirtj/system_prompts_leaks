# system_prompts_leaks — Claude Code Context

## Overview

- **Repository**: AiFeatures/system_prompts_leaks
- **Enterprise**: iAiFy
- **Description**: Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini

## Fork Notes

This is a fork of asgeirtj/system_prompts_leaks maintained under iAiFy enterprise.
